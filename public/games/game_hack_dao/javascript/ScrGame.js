...
ScrGame.prototype.init = function() {
	...
	if(options_ethereum){
		...
		this.response("getBalance", 1000*1000000000000000000)
		this.response("getBalanceBank", 100000*1000000000000000000)
	}
